          ...
          <div className="flex flex-col p-4 gap-4">
              ...
              <div className="flex gap-2 overflow-scroll">
                  {categories.map((category, index) => (
                      <Link key={index} to="/explore/$category" params={{category}}className="h-10 flex items-center px-5 bg-eventr-gray-200/20 text-eventr-gray-50 outline-none rounded-xl">
                          {category}
                      </Link>
                  ))}
              </div>
