...
function RouteComponent() {
  ...
  const years = Array.from( { length: 99 },
  ...
  <div className="relative h-screen flex flex-col">
    ...
    />
    <form onSubmit={handleSubmit} className="relative flex-grow bg-eventr-gray-50 text-eventr-gray-900 rounded-t-3xl px-4 flex flex-col gap-4">
