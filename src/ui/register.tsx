...
export default function Register() {
    ...
    <>
    {registerModal &&
        <div className='fixed top-0 z-50 w-full h-screen p-2 bg-black/20'>
            <motion.div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  flex items-center w-[380px] p-8 rounded-lg h-min bg-white shadow-xl text-black flex-col gap-6"
                animate={{ height: step === "register" ? "555px" : "300px" }}
                transition={{ duration: 0.4, delay: 0.2, ease: "easeInOut" }}
            >    
                <button onClick={() => setRegisterModal(false)} className='absolute top-4 right-4'><Icon icon='close'/></button>    
